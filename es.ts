export const ES = {
    ...
    TitaniumAlloyPlant: "Planta de aleación de titanio",
    ...
    UseTradeCenterPrice: "Utilice el precio del Trade Center",
    AddTrade: "Agregar Trade",
    ActiveTrades: "Trades activos",
    AcceptTrade: "Aceptar",
    CancelTrade: "Cancelar",
    RefundTrade: "Reenbolso de trade",
    RefundTradeSuccess: "Este trade ha sido reembolsado:% {resource} ha sido reembolsado a su trade center",
    RefundTradeFail: "No se pudo reembolsar este trade. Vuelve a intentarlo más tarde.",
    ClaimTrade: "Reclamar",
    ...
    CancelActiveTradeFirst: "Tienes trades de jugadores activos,por favor cancele/reclame primero",
    FailedToCheckActiveTrade: "Failed to check active player trades, please try again later",
    PlayerTradeQuotaExceed: "Este trade ha superado su cuota",
    PlayerTradeValidRange: "Rango: %{min} ~ %{max}",
    PlayerTradeFilterCanAfford: "Puede permitirse",
    PlayerTradeQuota: "Cuota restante: %{value}",
    PlayerTradeUnavailable:
        "Debes tener al menos un recurso en producción y almacenamiento antes de poder hacer trade con jugadores.",
    ...
    PowerBankMoreCapacity: "Ahorro de batería",
    PowerBankMoreCapacityDesc: "Los bancos de energía se cargan al 50% de velocidad pero tienen un 50% más de capacidad",
    PowerBankNotWorking: "⛔ los bancos de energía solo funcionan junto a una planta de energía",
    ExcludeBuildingsShutdown: "Excluir edificios que están desactivados",
    ColorTheme: "Tema de color del juego",
    ColorThemeDesc: "Tema de color para iconos de juegos, resaltado, cuadrícula y fondo. REQUIERE RECARGAR",
    SiliconMine2xOutput: "Valle de silicio",
    SiliconMine2xOutputDesc:
        "Las minas de silicio producen 2 veces más silicio, pero utilizan un 50% más de energía y el transporte de silicio cuesta un 50% más de combustible.",
    CoalMine2xOutput: "Revolución industrial",
    CoalMine2xOutputDesc: "Las minas de carbón producen el doble de carbón, pero utilizan un 50% más de energía y el transporte de carbón cuesta un 50% más de combustible.",
